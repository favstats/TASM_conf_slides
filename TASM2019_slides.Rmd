...
+ YouTube Experimental design 
    + Created **THREE** identical accounts
    + All follow same 10 XRW accounts; 10 Neutral
...
+ Pull 18 Recommended  Videos of each account **two times a day** for *two weeks*.

+ Every piece of content gets a unique rank per session and an Extremist Media Index (EMI) Score (Holbrook, 2015)

+ Satisfactory interrater reliability between two individuals  (Krippendorff's alpha: 0.77)
...
+ Fringe content 1.72 (p < 0.01) times more likely than before

+ Extreme content 2.47 (p < 0.01) times more likely than before
...
+ Reddit Experimental design 
    + Created **THREE** identical accounts
    + All follow same 10 XRW subreddits; 10 Neutral
    + Each account interacts with different kinds of content


+ Visited the site twice per day for 2 weeks and collected data for 25 threads on the *“Best”* personalized timeline
...
+ Extreme content is pushed up the ranking of recommended videos on the YouTube 
